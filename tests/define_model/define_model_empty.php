...
echo("\n");
echo("prints baz3\n");
echo($protocol3->case("myFoo")->when(["foo"=>$foo,"foo2"=>$foo2])->get());
echo("\n");
echo("\n");
...
$foo2="bar";
echo("prints qux\n");
echo($protocol->case("myFoo")->when()->get());
echo("\n");
echo("prints baz2\n");
echo($protocol2->case("myFoo")->when()->get());
echo("\n");
echo("prints baz3\n");
echo($protocol3->case("myFoo")->when()->get());
echo("\n");
